...
public class TavernaInput {
    ...
    public void setStringInput(String value) throws TavernaException {
        resetInputs();
        if (value == null){
            throw new NullPointerException ("Null value is not allowed as input.");
        }
//        if (value.contains("\n")){
...
//        }
   ...
   /**
    ...
    /**
     * Returns an object associated with this input. If the input contains an actual value, it will be returned. 
     * If the input is from a URL, it will download the data and return is as a byte array.
     * @return 
     */
    public Object getValue(){
        ...
        if (uri != null) {
	        ...
	        while ((bytesRead = is.read(byteChunk)) > 0) {
                ...
                System.out.println("Failed to download input from " + uri);
                ex.printStackTrace();       
                return null;
    ...
    /**
     * Returns the arguments associated with this input and its values.
     * <p>
     * For lists of values a delimiter is auto-generated so that the whole list is passed as a single parameter split 
     *    by this list.
     * 
     * @return The arguments required to express this input.
     * 
